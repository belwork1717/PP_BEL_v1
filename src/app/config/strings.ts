...
export const STRINGS = {
  ...
  SOURCING: {
    ...
    SPECIFICATION_FORM: {
      ...
      CREATE_LOT_BUILDER_SUBTITLE:
        "Add each material once or multiple times to create separate lots under the same material. Supply order, receipt date, and manufacturer apply to the material; enter lot ID, analyzed results, out-of-range flags, remarks, and certificates per lot.",
      LOT_LABEL: "Lot",
      ...
      SUBMIT_DISABLED_TOOLTIP: "Fill at least one analyzed result per material before submitting",
    ...
    CASING_FORM: {
      ...
      NOT_READY_TO_SUBMIT: "Fill Motor ID and Clearance Report first",
      ACTION_HELPER: "All mandatory fields must be completed. Waivers and visual observation are optional.",
      ...
      FORM_ID_MISSING: "Unable to continue. Form ID is missing for this batch.",
      BATCH_ID_MISSING: "Unable to create casing form. Batch ID is missing.",
      SUB_DEPARTMENT_MISSING: "Unable to proceed. Sub-department context is missing.",
  ...
  MANUFACTURING: {
    ...
    RAW_MATERIAL_PREP: {
      ...
      SELECT_AT_LEAST_ONE: "Select at least one type to load the form",
      LOCK_EXPLANATION: "Delete all sections inside a builder first to deselect its type.",
      NO_TYPE_SELECTED_TITLE: "No material type selected",
      NO_TYPE_SELECTED_SUBTITLE: "Check Solid, Liquid, Linear, or any combination above to load the corresponding form builder",
    ...
    MIXING: {
      ...
      NEW_LABEL: "New Submission",
      FORM_TITLE: "Mixing",
      FORM_SUBTITLE: "Pre-mixing and final mixing operation parameters",
  ...
  BATCH_MANAGEMENT: {
    ...
    TABLE_COLS: ["Batch ID", "Motor ID", "Motor Type", "Stage", "Status", "Priority", "System Manager", "Actions"],
    FORM: {
