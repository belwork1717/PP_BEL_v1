...
// Add these new imports for Manufacturing
...
import GrainRoundedIcon from "@mui/icons-material/Grain";
...
import RulerRoundedIcon from "@mui/icons-material/StraightenRounded";
...
export const icons = {
  ...
  Store: StoreIcon,
  RawMaterial: InventoryIcon,
  Casing: ConstructionIcon,
  ...
  weight: ScaleIcon,
  dimensions: StraightenIcon,
  upload: UploadFileIcon,
  media: VideoCameraBackIcon,

  file: FilePresentIcon,
